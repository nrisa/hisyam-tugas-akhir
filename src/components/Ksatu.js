            ...
            <div className="main-fix">
                ...
                <div className="card-fix">
                    ...
                    <div className="main-cms">
                        <div className="kotak-mitra" onClick={()=>props.sub('step2')}>
                            <h5 style={{marginBottom:'10px'}}>Waste4Change Bekasi</h5>
                            <span className="consi">
                                <span className="ticon">
                                    <img width={'8px'} src={map} className="ticon-icon" />
                                </span>
                                <span className="tisi">
                            ...
                            <span className="consi">
                                <span className="ticon">
                                    <img width={'12px'} src={call} className="ticon-icon" />
                                </span>
                                <span className="tisi">
                                082111100170
                                </span>
                            ...
                            <span className="consi">
                                <span className="ticon">
                                    <img width={"10px"} src={date} className="ticon-icon" />
                                </span>
                                <span className="tisi">
